  ...
  final entries = [
    Container(
      ...
      decoration: BoxDecoration(
          color: const Color.fromRGBO(96, 200, 166, 1),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: const Color.fromRGBO(96, 200, 166, 1), width: 5)),
    ...
    Container(
      ...
      child: const Center(
        child: Text(
          "App designed for sharing traveling experience.",
...
class _EmailRowState extends State<EmailRow> {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
      const Icon(FontAwesomeIcons.envelopeCircleCheck, color: Colors.green),
      Text(_email),
      IconButton(
          onPressed: (() async {
